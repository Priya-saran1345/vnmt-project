  ...
  return (
    <div className="pb-0">
      ...
      <div className="bg-black  -mt-20 pt-28 text-white/80">
        <div className="w-full relative lg:w-[95%] 2xl:w-[77%] mx-auto py-12">
        <div
          className="absolute inset-0 top-16  bg-fixed animate-background-move"
          style={{
          ...
          <div className="">
            <div className="flex justify-center mx-auto">
              <div className="px-4 border-blue border-r-2 w-[20%] pt-3">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-white/70 hover:text-orange cursor-pointer">
                      VIC4 Rockwell Cres, Truganina VIC 3029, Australia-0113004747617
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70 hover:text-orange cursor-pointer">
                      6th Floor, 625 & 626, Gera&apos;sImperium Rise, Hinjewadi Phase 2,Pune ,Maharashtra - 41157 +91
                      9023403569
                    </p>
                  </div>
                  <div>
                ...
                <h3 className="font-bold mb-4 underline hover:text-blue cursor-pointer mt-4">
            ...
            <div className="flex mt-4 px-4 gap-10">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((elem) => (
                <Image key={elem} src={`/images/footer${elem}.svg`} height={50} width={64} alt="" />
              ))}
            </div>
          </div>
        </div>
